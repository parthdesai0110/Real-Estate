$(document).ready(function(){
    ...
    $('#account_register').click(function(){
        ...
        if(flag){
            $.ajax({
                url: baseurl+"welcome/save_add_property",
                data:{
                    title:title, 
					...
					monthly_rent_min:monthly_rent_min, monthly_rent_max:monthly_rent_max, furnished:furnished, luxury_unit:luxury_unit, available_as_of:available_as_of, sublease:sublease, kitchen_app:kitchen_app, laundry_app:laundry_app
                },
                type:'post',
                dataType: 'json',
