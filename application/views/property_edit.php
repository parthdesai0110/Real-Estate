...
<div class="row">
	...
	<div id="contact_table">
					...
					<span class="error" id="sold_error"></span>
					<Input type = 'Radio' class="radio_class" id="is_sold_yes" Name ='is_sold' <?php if($property["is_sold"] == "yes"){ ?>checked="checked"<?php } ?> value= 'yes'><label for="is_sold_yes" class="agent_class">Yes</label>
					<Input type = 'Radio' id="is_sold_no" <?php if($property["is_sold"] == "no"){ ?>checked="checked"<?php } ?> style="margin-left: 20px;" class="radio_class" Name ='is_sold' value= 'no'><label for="is_sold_no" class="agent_class">No</label>
					</div>
					
					<div style="padding: 10px; border: 1px solid #ccc; margin-bottom: 20px;">
					<label>Sold Date</label>
					<input type="text" id="sold_date" class="form-control" placeholder="Sold Date" name="sold_date" value="<?php echo $property["sold_date"]; ?>">
					</div>
