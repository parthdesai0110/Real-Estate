...
class Welcome extends CI_Controller {
    ...
    public function all_property() {
		...
		if($id == "price_desc"){
			$property  = $this->mdl_desktop->get_data_property_price_desc("property");
		}else if($id == "price_asc"){
			$property  = $this->mdl_desktop->get_data_property_price_asc("property");
		}else{
	...
	$search_text = $_POST['search_text'];
		...
		$property  = $this->mdl_desktop->get_data_search_property($search_text,$search_property_type,$search_price,$offer,$near_by);
    ...
    function save_add_property() {
        ...
        $temp['customer_id'] = $_POST['user_id'];
    ...
    function save_edit_property() {
        ...
        $temp['kitchen_app'] = $_POST['kitchen_app'];
        $temp['laundry_app'] = $_POST['laundry_app'];
        $temp['is_sold'] = $_POST['is_sold'];
        $temp['sold_date'] = $_POST['sold_date'];
